...
import { DEFAULT_PROMPT_TEMPLATES, useSettingsStore } from '../stores/settingsStore'
...
export function SettingsDialog({ open, onClose }: SettingsDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-lg w-[760px] max-h-[90vh] overflow-y-auto p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-4 inline-flex rounded-lg border border-border bg-muted/30 p-1">
          <button
            ...
            className={`px-3 py-1.5 text-sm rounded-md transition-colors ${
              activeTab === 'llm' ? 'bg-white shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
            LLM 配置
          </button>
          <button
            ...
            className={`px-3 py-1.5 text-sm rounded-md transition-colors ${
              activeTab === 'prompt' ? 'bg-white shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'
            }`}
          >
            Prompt 配置
          </button>
              ...
              <div className="rounded border border-border p-3 space-y-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-[220px] px-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                </div>
              ...
              <div className="rounded border border-border p-3 space-y-3">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-primary resize-y"
                    placeholder="系统提示词"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 border rounded focus:outline-none focus:ring-1 focus:ring-primary resize-y font-mono text-xs"
                  />
                </div>
